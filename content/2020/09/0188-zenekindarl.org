...
faster, not 25 times like promiced by the documentation.
...
allow to understand it's limits. Probably it is very extensible. Hope,
[[https://twitter.com/blackenedgold][@blackenedgold]] will write more documentation or a tutorial some day.
