...
POFTHEDAY> (let* ((data '(("Jinja2" 6.18 "red")
                          ("zenekindarl" 1.54 "green")
                          ("cl-who" 1.64 "blue")
                          ("spinneret" 4.94 "orange")
                          ("cl-mustache" 5.21 "cyan")))
...
Performance results for ~cl-mustache~ were added to the chart. Code is in
[[https://40ants.com/lisp-project-of-the-day/2020/09/0190-cl-mustache.html][the post #0190]].
