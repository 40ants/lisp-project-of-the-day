...
- 11 April - [[content/2020/04/0035-trivial-mmap.org][trivial-mmap]]
** March
...
* A way to find intereting stats from Quicklisp
        ...
        do (loop for system in systems
                 do (push line (gethash system result nil)))
                   ...
                   (loop with sorted = (sort (alexandria:hash-table-alist result)
                         ...
                         collect (cons system (length lines))))))
#+END_SRC
